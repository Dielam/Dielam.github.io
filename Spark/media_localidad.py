...
if len(sys.argv) > 1:
    ...
    if path.exists("outputLocalidad"):
        rmtree("outputLocalidad")
    sc = SparkContext()
    ...
    mediaTotal.saveAsTextFile("outputLocalidad/gasolina_95/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/gasoleo_A/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/gasoleo_B/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/bioetanol/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/nuevo_gasoleo_A/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/biodiesel/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/ether_metilico/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/bioalcohol/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/gasolina_98/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/gas_n_comprimido/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/gas_n_licuado/total")
    ...
    mediaTotal = precioRDD.map(lambda rows: ([rows[1], int(tamRDD)]))
    mediaTotal = mediaTotal.map(lambda calc:(calc[0]/calc[1]))
    mediaTotal.saveAsTextFile("outputLocalidad/glp/total")
else:
