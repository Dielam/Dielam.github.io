...
if len(sys.argv) <= 1:
    ...
    if len(sys.argv[1]) > 5:
        ...
        if data.isEmpty():
            ...
            result.saveAsTextFile("outputMin/minimo_cp_gasolina_95.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_gasoleo_a.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_gasoleo_b.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_bioetanol.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_nuevo_gasoleo_a.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_biodiesel.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_eter_metilico.txt")
        else:
            precio = data.map(lambda line: (str(line.split(',')[23]),float(line.split(',')[17]))) #map (Empresa, precio_ester_metilico)
            union = precio.sortBy(lambda line: line[1])
            result = sc.parallelize(union.first())

            result.saveAsTextFile("outputMin/minimo_cp_ester_metilico.txt")
        # f__bioalcohol = [18]
        data = text.filter(lambda line: str(line.split(',')[18]) != '')
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_bioalcohol.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_gasolina_98.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_gas_natural_comprimido.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_gas_natural_licuado.txt")
        else:
        ...
        if data.isEmpty():
            result = sc.parallelize("0")
            result.saveAsTextFile("outputMin/minimo_cp_gases_licuados_del_petr.txt")
        else:
